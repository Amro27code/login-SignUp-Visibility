        ...
        child: SingleChildScrollView(
          ...
          obscureText: obsecureText,
                ...
                decoration: InputDecoration(
                  ...
                  errorText:showErrorPassword? "Invalid Password"
                      :null,
                ),
                ...
                decoration: InputDecoration(
                  ...
                  suffix: IconButton(onPressed: (){setState(() {
                    robsecureText=!robsecureText;
                      ...
                      icon: robsecureText?Icon(Icons.visibility):Icon(Icons.visibility_off)),
                ),
              ),SizedBox(height: 8,),
              SizedBox(
                ...
                child: ElevatedButton(
                  ...
                  showErrorfName=fnameController.text.isEmpty?true:false;
                  showErrorlName=lnameController.text.isEmpty?true:false;
                  showErrorPassword=(!validatePassword(passwordController.text)||passwordController.text!=rPasswordController.text)?true:false;
                  });
                        if (fnameController.text.isNotEmpty &&
                            lnameController.text.isNotEmpty && !showErrorEmail&&!showErrorPassword){
